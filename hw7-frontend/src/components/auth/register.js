        ...
        <div id="panel-body text-center">
            <div className="form-group col-md-15">
                <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_username" type="text" ref={(node) => username1 = node } placeholder="account name"/>
                    </div>
                </div>
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_email" type="email" ref={(node) => email1 = node } placeholder="email address"/>
                    </div>
                </div>
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_phone" type="tel" ref={(node) => phone1 = node } placeholder="123-123-1234"/>
                    </div>
                </div>
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_birth" type="date" ref={(node) => birth1 = node } placeholder="mm/dd/yyyy"/>                  
                    </div>
                </div>                
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_zipcode" type="zipcode" ref={(node) => zipcode1 = node } placeholder="77005"/>
                    </div>
                </div>
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_password" type="password" ref={(node) => password1 = node } placeholder="password"/>
                    </div>
                </div>
                <div className="col-sm-10">
                    <div className="col-sm-10">
                    ...
                    <div className="col-sm-10">
                    <input className="form-control" id="register_confirm" type="password" ref={(node) => confirm1= node } placeholder="password confirmation"/>
                    </div>
                </div>
            </div>

            <div className="col-sm-3 col-sm-offset-1">
                <input type="button" value="Register" className="btn btn-primary" id='register_button'
